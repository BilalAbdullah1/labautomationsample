    ...
    if (isset($_POST['submit'])) {
        ...
        if ($user) {
            ...
            try {
                ...
                $mail->Username   = 'ayaansheik290@gmail.com';                     //SMTP username
                $mail->Password   = 'twgh xqmm euns zedh';                               //SMTP password
                $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
                $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

                //Recipients
                $mail->setFrom('ayaansheik290@gmail.com', 'labautomation');
                $mail->addAddress($email, $user_name);     //Add a recipient
                $range = rand(10, 100);
                //Content
                $mail->isHTML(true);                                  //Set email format to HTML
                $mail->Subject = 'Labautomation sent a verification code';
